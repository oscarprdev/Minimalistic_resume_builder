// .wrangler/tmp/bundle-ziUuUA/checked-fetch.js
...
var router_default = buildRouter;

// src/index.ts
var src_default = {
  async fetch(request, env) {
    if (env.router === void 0) {
      env.router = router_default(env);
    }
    return env.router.handle(request, env);
  }
};

// ../node_modules/.pnpm/wrangler@3.53.1_@cloudflare+workers-types@4.20240502.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../node_modules/.pnpm/wrangler@3.53.1_@cloudflare+workers-types@4.20240502.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-ziUuUA/middleware-insertion-facade.js
...
// ../node_modules/.pnpm/wrangler@3.53.1_@cloudflare+workers-types@4.20240502.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-ziUuUA/middleware-loader.entry.ts
