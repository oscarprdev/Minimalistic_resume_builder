...
const DEFAULT_IMAGE = 'https://pub-0e9cd559fbf645019c4e68f378549dc6.r2.dev/default-image.jpeg';
export const MAX_FILE_SIZE_MB = 2;

const AsideFormHeaderImage = ({ form, updateFormImageValue }: AsideFormHeaderImageProps) => {
	...
	return (
		<div className='flex flex-col space-y-2 w-[140px]'>
			<picture className='relative rounded-md w-full h-[140px]'>
				{loading && (
					<div className='absolute size-[140px] rounded-md opacity-60 bg-black grid place-items-center'>
				...
				<Image
					src={form.watch('image') || DEFAULT_IMAGE}
					alt='Resume image'
					width={600}
					height={600}
